...
public class RegistroCliente extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        Title.setText("Ingreso de un Nuevo Cliente");
        ...
        add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 270, 260, 50));
        ...
        Text8.setText("Código de Ciudad");
        ...
        add(ciudad, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 90, 260, 30));
        ...
        try {
            if (nombre.getText().equals("Ingrese el nombre") 
                ...
                if (uname == null || "".equals(uname)
                    ...
                    methods.setCliente(uciudad, uname, uape, ucor, usalario);
                    nombre.setText("");
                    apellido.setText("");
                    correo.setText("");
                    salario.setText("");
