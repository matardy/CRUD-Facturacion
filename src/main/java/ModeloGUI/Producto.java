...
public class Producto extends javax.swing.JFrame {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {
        methods.updateProducto(Integer.parseInt((String) cmbIDProducto.getSelectedItem()),txtNombreProducto.getText(),
                txtDescuento.getText(), txtUnidades.getText(), txtPrecio.getText());
        displayUpdatedData();
    }

    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {
        methods.deleteProducto(Integer.parseInt((String) cmbIDProducto.getSelectedItem()));
